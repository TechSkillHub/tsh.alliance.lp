    ...
    <div class="container boxes">
      <div class="row d-flex justify-content-between text-center">
        <div class="col-12 col-lg">
          <img src="./imgs/img1.webp" alt="" class="mb-4 img-fluid">
          <h2>Kids 1</h2>
        ...
        <div class="col-12 col-lg">
          <img src="./imgs/img2.webp" alt="" class="mb-4 img-fluid">
          <h2>Kids 2</h2>
        ...
        <div class="col-12 col-lg">
          <img src="./imgs/img3.webp" alt="" class="mb-4 img-fluid">
          <h2>Iniciantes</h2>
        ...
        <div class="col-12 col-lg">
          <img src="./imgs/img4.webp" alt="" class="mb-4 img-fluid">
          <h2>Intermediário</h2>
        ...
        <div class="col-12 col-lg">
          <img src="./imgs/img5.webp" alt="" class="mb-4 img-fluid">
          <h2>Avançado</h2>
